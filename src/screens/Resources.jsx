...
export function Resources({ go, userId, isTrainer }) {
  ...
  return (
    <div className={isTrainer ? 'scroller coach-wrap' : 'scroller'} style={isTrainer ? undefined : { padding: '0 16px 28px', paddingTop: 'calc(var(--safe-top) + 18px)', boxSizing: 'border-box' }}>
